...
export default function DropdownContainer({
  ...
  const [arrowPos, setArrowPos]         = useState<string | null>(null);
  ...
  const arrowConfigs: Record<string, { wrapperStyle: React.CSSProperties; diamondStyle: React.CSSProperties; borders: string }> = {
    top:    { wrapperStyle: { top: 0, left: arrowPos ?? undefined, transform: "translateX(-50%)" }, diamondStyle: { top: "-7px" }, borders: "border-t border-l border-purple-500" },
    bottom: { wrapperStyle: { bottom: 0, left: arrowPos ?? undefined, transform: "translateX(-50%)" }, diamondStyle: { bottom: "-7px" }, borders: "border-b border-r border-purple-500" },
    left:   { wrapperStyle: { left: 0, top: arrowPos ?? undefined, transform: "translateY(-50%)" }, diamondStyle: { left: "-7px" }, borders: "border-l border-b border-purple-500" },

...
function InputFieldset({ type = "text", id, value, onChange, placeholder, required = false }) {
  ...
  return (
    <label className="relative block w-full max-w-xs border border-gray-300 rounded-xl shadow-md 
    focus-within:border-purple-500 focus-within:ring-2 focus-within:ring-purple-500 transition-all mb-2 mx-auto">
      <input

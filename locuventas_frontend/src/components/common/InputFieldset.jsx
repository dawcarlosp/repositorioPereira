    ...
    >
      ...
      <span
        className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-base
          ...
          peer-focus:top-3 peer-focus:text-xs peer-focus:text-purple-500
          peer-not-placeholder-shown:top-3 peer-not-placeholder-shown:text-xs peer-not-placeholder-shown:text-purple-500"
      >
        {placeholder}
      </span>
      {type === "password" && (

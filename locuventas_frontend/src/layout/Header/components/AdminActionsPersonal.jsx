        ...
        {isAccordionOpen && (
          <div className="pl-4 flex flex-col gap-1 border-l border-zinc-800 ml-3 my-1 animate-in slide-in-from-top-1">
            <BotonClaro
              ...
              onClick={() => { h.closeAll(); navigate("/vendedores/pendientes"); }}
            >
              SOLICITUDES NUEVAS
            </BotonClaro>
            <BotonClaro
              className="!h-8 !text-[10px] !justify-start"
              onClick={() => { h.closeAll(); navigate("/vendedores/lista"); }}
            >
              LISTA DE PERSONAL
            </BotonClaro>
          </div>
  ...
  return (
   <div className="relative">
    ...
    <DropdownContainer
      ...
      side="right"
      width="w-56"
      className="absolute right-[calc(100%+20px)] top-0 z-[60]"  
    >
      <div className="flex flex-col gap-1 p-1">
        <div className="relative">
          <BotonClaro
          ...
          <DropdownContainer
            ...
            side="right"
            width="w-[380px]"
            className="absolute right-[calc(100%+20px)] top-0 z-[70]"  
          >
            <PendientesList

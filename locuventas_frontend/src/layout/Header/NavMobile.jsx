  ...
  return (
    <div className="md:hidden mx-4 mt-[2px] rounded-b-2xl bg-zinc-900/95 px-6 py-6 shadow-xl border-t border-white/10 animate-in fade-in zoom-in duration-300">
      ...
      <div className="flex flex-col gap-2">
        ...
        {esAdmin && (
          <div className="flex flex-col gap-2">
            <p className="text-xs font-bold text-orange-500 uppercase tracking-widest text-left ml-2">Administración</p>
            <BotonClaro onClick={() => toast.dark("Módulo de productos próximamente")}>
              Gestionar Productos
            </BotonClaro>
            <Link to="/vendedores/pendientes" onClick={h.closeAll}>
              <BotonClaro className="w-full text-left">Vendedores Pendientes</BotonClaro>
            </Link>
          </div>
        )}
